-- UPDATE INTERROGATION LINKING LOGIC
-- Remove the restriction that interrogations must not be linked to a case.
-- We want to allow linking ANY visible interrogation to an incident.
